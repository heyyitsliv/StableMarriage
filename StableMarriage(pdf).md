...
**Note:** Your final submission should include the input file which must be read into your chosen data structure, a person class file representing both genders with appropriate methods and static variables, and your stable marriage java class file that includes the main method and appropriate methods for testing, processing, and successful implementation.
